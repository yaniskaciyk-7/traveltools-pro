    ...
    if cle_api:
        ...
        with onglet1:
            ...
            with st.form("form_passport"):
                ...
                if submit1:
                    prompt = f"Vérifie si un voyageur de nationalité {nationalite} peut aller en {destination} avec un retour le {date_retour} et un passeport expirant le {expire_passeport}."
        ...
        with onglet2:
            ...
            with st.form("form_data"):
                ...
                if submit2:
                    prompt = f"Extrais les noms, prénoms et dates de naissance de ce texte : {texte_vrac}."
        ...
        with onglet3:
            ...
            with st.form("form_devis"):
                ...
                if submit3:
                    prompt = f"Trouve les points faibles cachés de ce devis de voyage et donne un script pour convaincre le client : {devis_concurrent}."
        ...
        # =====================================================================
        with onglet4:
            st.subheader("✈️ Sécurisation des Escales")
            with st.form("form_scale"):
                ...
                if submit4:
                    prompt = f"Dis si une escale de {temps_escale} à l'aéroport de {aeroport_escale} est risquée et s'il faut un visa de transit."
